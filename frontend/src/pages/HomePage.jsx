...
const HomePage = () => {
  return (
    <main className="site-shell home-page flex flex-col gap-5 float-in">
      <section className="page-hero">
        <p className="eyebrow text-xs uppercase tracking-[0.18em] text-slate-500">
          Ed-tech platform for practical careers
        </p>
        <h1 className="page-title mt-2 text-4xl md:text-5xl font-extrabold max-w-2xl text-slate-900">
          Build future-ready skills with creator-led cohorts.
        </h1>
        <p className="page-lead mt-3 text-slate-700 max-w-2xl">
